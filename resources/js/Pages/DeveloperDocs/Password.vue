...
const submit = () => {
    form.post(route('developer-docs.unlock'), {
    ...
    <div class="min-h-screen flex items-center justify-center" style="background-color: #1B142C;">
        <div class="w-full max-w-sm px-6">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-white">Developer Docs</h1>
                <p class="text-gray-400 mt-2 text-sm">Enter the password to access developer documentation.</p>
            </div>
