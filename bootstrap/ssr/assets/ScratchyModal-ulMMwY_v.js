import { defineComponent, computed, ref, onMounted, watch, onUnmounted, resolveComponent, mergeProps, withCtx, createTextVNode, toDisplayString, nextTick, useSSRContext, unref, createVNode, createBlock, openBlock, Fragment, renderList } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.modelValue) {
          ...
          if (__props.demoMode) {
            _push2(`<div class="mb-4 flex items-center space-x-3 bg-gray-800 rounded-lg p-2" data-v-026f2c60><span class="text-white text-sm font-medium" data-v-026f2c60>Preview Mode:</span><button class="${ssrRenderClass([
              "px-3 py-1 rounded text-sm font-medium transition-colors",
              actualPreviewMode.value === "mobile" ? "bg-blue-500 text-white" : "bg-gray-600 text-gray-300 hover:bg-gray-500"
            ])}" data-v-026f2c60>Mobile</button><button class="${ssrRenderClass([
              "px-3 py-1 rounded text-sm font-medium transition-colors",
              actualPreviewMode.value === "desktop" ? "bg-blue-500 text-white" : "bg-gray-600 text-gray-300 hover:bg-gray-500"
            ])}" data-v-026f2c60>Desktop</button></div>`);
          } else {
            _push2(`<!---->`);
          }
          ...
          if (__props.demoMode) {
            ...
            if (actualPreviewMode.value === "mobile") {
              _push2(`<div class="h-8 bg-black flex items-center justify-between px-4 text-white text-sm" data-v-026f2c60><span data-v-026f2c60>9:41</span><div class="flex space-x-1" data-v-026f2c60><div class="w-4 h-2 border border-white rounded-sm" data-v-026f2c60></div><div class="w-1 h-2 bg-white rounded-sm" data-v-026f2c60></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (actualPreviewMode.value === "desktop") {
              _push2(`<div class="h-10 bg-gray-700 flex items-center justify-between px-4 text-white text-sm border-b border-gray-600" data-v-026f2c60><div class="flex items-center space-x-2" data-v-026f2c60><div class="flex space-x-1" data-v-026f2c60><div class="w-3 h-3 bg-red-500 rounded-full" data-v-026f2c60></div><div class="w-3 h-3 bg-yellow-500 rounded-full" data-v-026f2c60></div><div class="w-3 h-3 bg-green-500 rounded-full" data-v-026f2c60></div></div><span class="ml-4 text-gray-300" data-v-026f2c60>Scratch Card - Scratch to Win!</span></div><div class="text-gray-400 text-xs" data-v-026f2c60>Chrome</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--]-->`);
          ...
          if (!__props.demoMode) {
            _push2(`<button class="absolute top-4 right-4 text-gray-700 bg-white/90 hover:bg-white rounded-full w-10 h-10 flex items-center justify-center focus:outline-none text-2xl z-50 shadow-lg transition-all duration-200 hover:scale-110" aria-label="Close" data-v-026f2c60>X</button>`);
          } else {
            _push2(`<!---->`);
          }
          if (showIntroVideo.value && hasIntroVideo.value) {
            _push2(`<div class="intro-video-overlay" data-v-026f2c60>`);
            if (isIntroVideoType.value) {
              _push2(`<video class="intro-video" playsinline preload="auto"${ssrRenderAttr("src", __props.assets.scratchyIntroVideo)} data-v-026f2c60></video>`);
            } else {
              _push2(`<img${ssrRenderAttr("src", __props.assets.scratchyIntroVideo)} class="intro-video" alt="Intro" data-v-026f2c60>`);
            }
            _push2(`</div>`);
          } else {
            _push2(`<!---->`);
          ...
          if (showLobby.value) {
            ...
            })}" data-v-026f2c60><div class="${ssrRenderClass([{ "shimmer-visible": !introPhase.value }, "shimmer-particles"])}" data-v-026f2c60><!--[-->`);
            ssrRenderList(8, (n) => {
              _push2(`<div class="shimmer-dot" style="${ssrRenderStyle({ "--shimmer-i": n, "--shimmer-accent": accentColor.value })}" data-v-026f2c60></div>`);
            });
            _push2(`<!--]--></div><div class="${ssrRenderClass([{ "intro-active": introPhase.value }, "lobby-content"])}" data-v-026f2c60>`);
            if (__props.assets.header) {
              _push2(`<div class="${ssrRenderClass([{ "logo-intro": introPhase.value, "logo-settled": !introPhase.value }, "lobby-logo-wrapper"])}" style="${ssrRenderStyle({ "--accent": accentColor.value })}" data-v-026f2c60><img${ssrRenderAttr("src", __props.assets.header)} alt="Game Header" class="lobby-header-image" data-v-026f2c60></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (!introPhase.value) {
              _push2(`<div class="lobby-rest" data-v-026f2c60>`);
              if (__props.assets.scratchyTitleText) {
                _push2(`<div class="lobby-title-area lobby-stagger-1" data-v-026f2c60><div class="title-banner" data-v-026f2c60><h1 class="lobby-title" style="${ssrRenderStyle({ color: titleColor.value })}" data-v-026f2c60>${ssrInterpolate(__props.assets.scratchyTitleText)}</h1></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (topPrize.value && showTopPrize.value) {
                _push2(`<div class="top-prize-badge lobby-stagger-2" style="${ssrRenderStyle({ "--prize-accent": accentColor.value })}" data-v-026f2c60><div class="prize-sparkle-ring" data-v-026f2c60>`);
                if (topPrize.value.image_path) {
                  _push2(`<img${ssrRenderAttr("src", topPrize.value.image_path)}${ssrRenderAttr("alt", topPrize.value.name)} class="prize-image" data-v-026f2c60>`);
                } else if (__props.assets.header) {
                  _push2(`<img${ssrRenderAttr("src", __props.assets.header)}${ssrRenderAttr("alt", topPrize.value.name)} class="prize-image" data-v-026f2c60>`);
                } else {
                  _push2(`<div class="prize-placeholder" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60>★</div>`);
                }
                _push2(`</div><div class="prize-details" data-v-026f2c60><span class="prize-label" data-v-026f2c60>TOP PRIZE</span><span class="prize-value" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60>`);
                ...
                _push2(`</span><span class="prize-name" data-v-026f2c60>${ssrInterpolate(topPrize.value.name)}</span></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (__props.tickets && __props.tickets.length > 0) {
                _push2(`<div class="lobby-ticket-display lobby-stagger-3" data-v-026f2c60><div class="ticket-count-circle" style="${ssrRenderStyle({ "--circle-color": accentColor.value })}" data-v-026f2c60><span class="ticket-number" data-v-026f2c60>${ssrInterpolate(displayTicketCount.value)}</span><span class="ticket-label" data-v-026f2c60>cards</span></div><p class="ticket-prompt" data-v-026f2c60>waiting to be scratched!</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="lobby-buttons lobby-stagger-4" data-v-026f2c60><button class="lobby-btn lobby-btn-primary" style="${ssrRenderStyle({
                "--btn-color": accentColor.value,
                "--btn-glow": accentColor.value
              })}" data-v-026f2c60><span class="btn-icon" data-v-026f2c60><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" data-v-026f2c60><path d="M12 2L15 8H9L12 2Z" stroke-linecap="round" stroke-linejoin="round" data-v-026f2c60></path><circle cx="12" cy="14" r="6" data-v-026f2c60></circle><path d="M9 14L11 16L15 12" stroke-linecap="round" stroke-linejoin="round" data-v-026f2c60></path></svg></span><span class="btn-text" data-v-026f2c60>Let&#39;s Scratch!</span></button><button class="lobby-btn-help" style="${ssrRenderStyle({ "--help-color": accentColor.value })}" data-v-026f2c60><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-026f2c60><circle cx="12" cy="12" r="10" data-v-026f2c60></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" data-v-026f2c60></path><line x1="12" y1="17" x2="12.01" y2="17" data-v-026f2c60></line></svg> How to Play </button></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (showHowToPlay.value) {
              _push2(`<div class="htp-overlay" data-v-026f2c60><div class="htp-modal" data-v-026f2c60><button class="htp-close" data-v-026f2c60>X</button><h2 class="htp-title" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60>How to Play</h2><div class="htp-steps" data-v-026f2c60><div class="step" data-v-026f2c60><div class="step-number" style="${ssrRenderStyle({ background: accentColor.value })}" data-v-026f2c60>1</div><div class="step-content" data-v-026f2c60><h3 data-v-026f2c60>Scratch the Surface</h3><p data-v-026f2c60>Drag your finger or mouse across the silver surface to scratch it off.</p></div></div><div class="step" data-v-026f2c60><div class="step-number" style="${ssrRenderStyle({ background: accentColor.value })}" data-v-026f2c60>2</div><div class="step-content" data-v-026f2c60><h3 data-v-026f2c60>Reveal Your Prize</h3><p data-v-026f2c60>Once enough is scratched, the card auto-reveals what&#39;s underneath!</p></div></div><div class="step" data-v-026f2c60><div class="step-number" style="${ssrRenderStyle({ background: accentColor.value })}" data-v-026f2c60>3</div><div class="step-content" data-v-026f2c60><h3 data-v-026f2c60>Collect Winnings</h3><p data-v-026f2c60>Winning tickets are added to your account instantly!</p></div></div></div><div class="htp-tip" data-v-026f2c60><span class="tip-icon" data-v-026f2c60>💡</span><span data-v-026f2c60>Use &quot;Reveal All&quot; to scratch all cards at once!</span></div><button class="htp-got-it" style="${ssrRenderStyle({ background: accentColor.value })}" data-v-026f2c60> Got it! </button></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          ...
          if (showGameBoard.value) {
            _push2(`<button type="button" class="game-scroll-arrow game-scroll-arrow-up md:hidden"${ssrIncludeBooleanAttr(isAtTop.value) ? " disabled" : ""} aria-label="Scroll up" data-v-026f2c60><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-026f2c60><polyline points="18 15 12 9 6 15" data-v-026f2c60></polyline></svg></button>`);
          } else {
            _push2(`<!---->`);
          }
          if (showGameBoard.value) {
            _push2(`<button type="button" class="game-scroll-arrow game-scroll-arrow-down md:hidden"${ssrIncludeBooleanAttr(isAtBottom.value) ? " disabled" : ""} aria-label="Scroll down" data-v-026f2c60><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-026f2c60><polyline points="6 9 12 15 18 9" data-v-026f2c60></polyline></svg></button>`);
          } else {
            _push2(`<!---->`);
          }
          if (showGameBoard.value) {
            _push2(`<div class="${ssrRenderClass(["flex flex-col relative game-wrapper overflow-y-auto overflow-x-hidden", __props.demoMode ? "flex-1" : "h-full"])}" data-v-026f2c60>`);
            if (__props.demoMode) {
              _push2(`<button class="demo-back-btn" data-v-026f2c60>Back to Lobby</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.assets.header) {
              _push2(`<img${ssrRenderAttr("src", __props.assets.header)} class="mx-auto max-w-[200px] w-auto h-auto object-contain mt-2 mb-1 pointer-events-none relative z-10" alt="Game Header" data-v-026f2c60>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex items-center justify-center relative z-10" data-v-026f2c60>`);
            ...
            _push2(`</div>`);
            if (topPrize.value && showTopPrize.value) {
              _push2(`<div class="top-prize-banner relative z-10 mx-4 my-2" data-v-026f2c60><div class="flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl" style="${ssrRenderStyle({ backgroundColor: "rgba(0,0,0,0.5)", border: `2px solid ${accentColor.value}`, boxShadow: `0 0 15px ${accentColor.value}40` })}" data-v-026f2c60>`);
              if (topPrize.value.image_path) {
                _push2(`<img${ssrRenderAttr("src", topPrize.value.image_path)}${ssrRenderAttr("alt", topPrize.value.name)} class="w-10 h-10 object-contain rounded-lg" data-v-026f2c60>`);
              } else if (__props.assets.header) {
                _push2(`<img${ssrRenderAttr("src", __props.assets.header)}${ssrRenderAttr("alt", topPrize.value.name)} class="w-10 h-10 object-contain rounded-lg" data-v-026f2c60>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex flex-col items-center" data-v-026f2c60><span class="text-[10px] uppercase tracking-widest font-bold text-gray-300" data-v-026f2c60>Top Prize</span><span class="text-lg font-black" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60>`);
              if (topPrize.value.isTicketBundle) {
                _push2(`<!--[-->${ssrInterpolate(Math.floor(topPrize.value.value))} Free Ticket${ssrInterpolate(topPrize.value.value != 1 ? "s" : "")}<!--]-->`);
              } else {
                _push2(`<!--[-->${ssrInterpolate(topPrize.value.isNoAutoCredit ? "Up to " : "")}£${ssrInterpolate(topPrize.value.value)}<!--]-->`);
              }
              _push2(`</span></div><span class="text-xs font-semibold text-white/80" data-v-026f2c60>${ssrInterpolate(topPrize.value.name)}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (!__props.demoMode) {
              _push2(`<div class="flex justify-center pt-2 pb-4 relative z-10" data-v-026f2c60>`);
          ...
          if (showWinSummary.value) {
            _push2(`<div class="win-summary-overlay" data-v-026f2c60><div class="win-summary-modal" style="${ssrRenderStyle({ "--ws-accent": accentColor.value })}" data-v-026f2c60><button class="win-summary-close" data-v-026f2c60>X</button><div class="win-summary-header" data-v-026f2c60><h2 class="win-summary-title" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60>You Won!</h2><p class="win-summary-subtitle" data-v-026f2c60>${ssrInterpolate(collectedWins.value.length)} win${ssrInterpolate(collectedWins.value.length !== 1 ? "s" : "")} from ${ssrInterpolate(__props.tickets.length)} cards</p></div><div class="win-summary-carousel" data-v-026f2c60>`);
                  ...
                  ssrRenderList(collectedWins.value, (win, idx) => {
                    _push3(ssrRenderComponent(unref(SwiperSlide), { key: idx }, {
                      default: withCtx((_2, _push4, _parent3, _scopeId2) => {
                        if (_push4) {
                          _push4(`<div class="win-slide" data-v-026f2c60${_scopeId2}><div class="win-slide-row" data-v-026f2c60${_scopeId2}><button class="win-nav-prev win-nav-arrow" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60${_scopeId2}><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-026f2c60${_scopeId2}><polyline points="15 18 9 12 15 6" data-v-026f2c60${_scopeId2}></polyline></svg></button><div class="win-slide-image-wrap" style="${ssrRenderStyle({ borderColor: accentColor.value })}" data-v-026f2c60${_scopeId2}><img${ssrRenderAttr("src", win.image)}${ssrRenderAttr("alt", win.categoryName)} class="win-slide-image" data-v-026f2c60${_scopeId2}></div><button class="win-nav-next win-nav-arrow" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60${_scopeId2}><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-026f2c60${_scopeId2}><polyline points="9 18 15 12 9 6" data-v-026f2c60${_scopeId2}></polyline></svg></button></div><div class="win-slide-prize" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60${_scopeId2}>${ssrInterpolate(win.prize)}</div><div class="win-slide-ticket" data-v-026f2c60${_scopeId2}>Ticket #${ssrInterpolate(win.ticketNumber)}</div></div>`);
                        } else {
                          return [
            ...
            if (totalWinnings.value > 0) {
              _push2(`<div class="win-summary-total" style="${ssrRenderStyle({ borderColor: accentColor.value + "40" })}" data-v-026f2c60><span class="win-total-label" data-v-026f2c60>Total Winnings</span><span class="win-total-value" style="${ssrRenderStyle({ color: accentColor.value })}" data-v-026f2c60>£${ssrInterpolate(totalWinnings.value.toFixed(2))}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button class="win-summary-btn" style="${ssrRenderStyle({ background: accentColor.value })}" data-v-026f2c60> Continue </button></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
          if (__props.demoMode) {
            _push2(`<div class="mt-2 text-center text-gray-400 text-xs" data-v-026f2c60>${ssrInterpolate(actualPreviewMode.value === "mobile" ? "Mobile Preview (420x750)" : "Desktop Preview (700x750)")}</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
...
const ScratchyModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-026f2c60"]]);
export {
